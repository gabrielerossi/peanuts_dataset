...
def main():
    ...
    #print("Scrape time: {} seconds.".format(execution_time))
    ...
    #execution_time = end_time - start_time
    #print("Frame extractor time: {} seconds.".format(execution_time))
    ...
    execution_time = end_time - start_time
    print("Extract text time: {} seconds.".format(execution_time))
    ...
    for path in splitted_images_paths:
        ...
        execution_time = end_time - start_time
        print("Inpaint time: {} seconds.".format(execution_time))
        ...
        execution_time = end_time - start_time
        print("Resize time: {} seconds.".format(execution_time)) """
